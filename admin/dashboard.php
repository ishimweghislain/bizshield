    ...
    <main class="flex-grow p-10">
        ...
        <header class="flex items-center justify-between mb-10" data-aos="fade-down">
            <div>
                ...
                <p class="text-sm text-gray-400 font-medium">Manage and monitor all activities at a glance.</p>
            </div>
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="group hover:bg-gray-50/50 transition-all">
                            ...
                            <td class="px-6 py-5 text-right">
                                <a href="organizations.php?action=view&id=<?php echo $org['id']; ?>" class="p-2 text-gray-400 hover:text-primary transition-all">
