...
<body class="bg-gray-50/50">
    ...
    <main class="flex-grow p-6 lg:p-10 pb-32">
        ...
        <header class="mb-10" data-aos="fade-down">
            <h1 class="text-2xl lg:text-3xl font-black text-gray-900 mb-1">Portal Configuration</h1>
            <p class="text-sm text-gray-400 font-medium">Control the global parameters and portal access.</p>
        </header>

        <div class="max-w-3xl">
            <div class="bg-white border border-gray-100 rounded-[2.5rem] shadow-soft shadow-green-900/5 p-8 lg:p-12" data-aos="fade-up">
